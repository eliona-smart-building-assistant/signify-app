...
type Configuration struct {
	...
	ServiceSecret   string            `boil:"service_secret" json:"service_secret" toml:"service_secret" yaml:"service_secret"`
	AppKey          string            `boil:"app_key" json:"app_key" toml:"app_key" yaml:"app_key"`
	AppSecret       string            `boil:"app_secret" json:"app_secret" toml:"app_secret" yaml:"app_secret"`
...
var ConfigurationTableColumns = struct {
	...
	ServiceSecret:   "configuration.service_secret",
...
var ConfigurationWhere = struct {
	...
	ServiceSecret   whereHelperstring
	AppKey          whereHelperstring
	AppSecret       whereHelperstring
	...
	ID:              whereHelperint64{field: "\"signify\".\"configuration\".\"id\""},
	BaseURL:         whereHelperstring{field: "\"signify\".\"configuration\".\"base_url\""},
	Service:         whereHelperstring{field: "\"signify\".\"configuration\".\"service\""},
	ServiceID:       whereHelperstring{field: "\"signify\".\"configuration\".\"service_id\""},
	ServiceSecret:   whereHelperstring{field: "\"signify\".\"configuration\".\"service_secret\""},
	AppKey:          whereHelperstring{field: "\"signify\".\"configuration\".\"app_key\""},
	AppSecret:       whereHelperstring{field: "\"signify\".\"configuration\".\"app_secret\""},
	RefreshInterval: whereHelperint32{field: "\"signify\".\"configuration\".\"refresh_interval\""},
	RequestTimeout:  whereHelperint32{field: "\"signify\".\"configuration\".\"request_timeout\""},
	AssetFilter:     whereHelpernull_JSON{field: "\"signify\".\"configuration\".\"asset_filter\""},
	Active:          whereHelpernull_Bool{field: "\"signify\".\"configuration\".\"active\""},
	Enable:          whereHelpernull_Bool{field: "\"signify\".\"configuration\".\"enable\""},
	ProjectIds:      whereHelpertypes_StringArray{field: "\"signify\".\"configuration\".\"project_ids\""},
	UserID:          whereHelpernull_String{field: "\"signify\".\"configuration\".\"user_id\""},
}
...
var (
	configurationAllColumns            = []string{"id", "base_url", "service", "service_id", "service_secret", "app_key", "app_secret", "refresh_interval", "request_timeout", "asset_filter", "active", "enable", "project_ids", "user_id"}
	configurationColumnsWithoutDefault = []string{"base_url", "service", "service_id", "service_secret", "app_key", "app_secret"}
...
func (o *Configuration) Assets(mods ...qm.QueryMod) assetQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"signify\".\"asset\".\"configuration_id\"=?", o.ID),
	)
...
func (configurationL) LoadAssets(ctx context.Context, e boil.ContextExecutor, singular bool, maybeConfiguration interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`signify.asset`),
		qm.WhereIn(`signify.asset.configuration_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	for _, rel := range related {
		if insert {
			...
			updateQuery := fmt.Sprintf(
				"UPDATE \"signify\".\"asset\" SET %s WHERE %s",
...
func Configurations(mods ...qm.QueryMod) configurationQuery {
	mods = append(mods, qm.From("\"signify\".\"configuration\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"signify\".\"configuration\".*"})
	}
...
func FindConfiguration(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Configuration, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"signify\".\"configuration\" where \"id\"=$1", sel,
	)
...
func (o *Configuration) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"signify\".\"configuration\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"signify\".\"configuration\" %sDEFAULT VALUES%s"
		}
...
func (o *Configuration) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"signify\".\"configuration\" SET %s WHERE %s",
...
func (o ConfigurationSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"signify\".\"configuration\" SET %s WHERE %s",
...
func (o *Configuration) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"signify\".\"configuration\"", updateOnConflict, ret, update, conflict, insert, opts...)
...
func (o *Configuration) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"signify\".\"configuration\" WHERE \"id\"=$1"
...
func (o ConfigurationSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"signify\".\"configuration\" WHERE " +
...
func (o *ConfigurationSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"signify\".\"configuration\".* FROM \"signify\".\"configuration\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, configurationPrimaryKeyColumns, len(*o))
...
func ConfigurationExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"signify\".\"configuration\" where \"id\"=$1 limit 1)"

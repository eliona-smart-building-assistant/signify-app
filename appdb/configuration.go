...
var (
	configurationAllColumns            = []string{"id", "base_url", "service", "service_id", "service_secret", "app_key", "app_secret", "refresh_interval", "request_timeout", "asset_filter", "active", "enable", "project_ids"}
...
func (configurationL) LoadAssets(ctx context.Context, e boil.ContextExecutor, singular bool, maybeConfiguration interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`signify.asset.configuration_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Configuration) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"signify\".\"configuration\"", updateOnConflict, ret, update, conflict, insert)
